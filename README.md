...
This repository contains a comprehensive Governance, Risk, and Compliance (GRC) assessment conducted for a simulated organization, **Oscorp**, using the **NIST SP 800-53 Rev. 5** framework. The project demonstrates an end-to-end, enterprise-style cybersecurity risk assessment lifecycle, including asset identification, risk analysis, NIST control mapping, control evaluation, policy mapping, gap analysis, and the development of a prioritized security roadmap.

The project is designed as a professional portfolio artifact to showcase practical GRC skills, structured methodology, and alignment with globally recognized cybersecurity standards.
...
* Identify critical organizational assets and dependencies
  n- Analyze cybersecurity risks based on threats and vulnerabilities
...
* Present findings in a professional GRC assessment report
...
├── 07-Gap-Analysis/                 # Identification of security gaps
├── 08-Recommendations-Roadmap/      # Prioritized remediation roadmap
├── 09-Advanced-GRC/                 # Advanced analytics and dashboards
├── Final-Report/                    # Professional GRC assessment report
└── README.md                        # Project overview and documentation
